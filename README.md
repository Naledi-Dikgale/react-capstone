...
**Stock-Market Project** Stock-Market is an application that displays a list of businesses and the overview of their finances, allows the user to filter and search for details of specific business.
...
git clone https://github.com/Naledi-Dikgale/react-capstone.git
